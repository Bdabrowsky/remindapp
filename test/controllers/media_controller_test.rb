...
class MediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medium" do
    assert_difference('Medium.count') do
      post media_url, params: { medium: { author: @medium.author, body: @medium.body, title: @medium.title } }
    end
  ...
  test "should update medium" do
    patch medium_url(@medium), params: { medium: { author: @medium.author, body: @medium.body, title: @medium.title } }
